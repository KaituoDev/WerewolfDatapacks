...
# execute unless predicate ww:started at 4ea3b9e5-2a17-4f22-a146-72b68bf85928 as @a[gamemode=!spectator,distance=..4] unless data entity @s Inventory[{tag:{stew:1b}}] run give @s mushroom_stew{display:{Name:'{"text":"母湯","color":"gold","bold":true,"italic":false}',Lore:['{"text":"一碗母湯","color":"white","italic":false}']},stew:1b} 1