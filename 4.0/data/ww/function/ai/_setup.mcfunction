...
data merge entity @s {VillagerData:{level:99,profession:"minecraft:farmer",type:"minecraft:snow"},Offers:{Recipes:[{maxUses:1,priceMultiplier:100f,specialPrice:1000,buy:{id:"minecraft:bedrock",count:1},buyB:{id:"minecraft:structure_void",count:1},sell:{id:"minecraft:netherite_axe",count:99,components:{"minecraft:max_stack_size":99,"minecraft:custom_name":'{"bold":true,"color":"red","italic":false,"text":"红色斧头"}',"minecraft:unbreakable":{},"minecraft:rarity":"epic","minecraft:food":{nutrition:1000,saturation:1000,can_always_eat:true,eat_seconds:1}}}}]}}