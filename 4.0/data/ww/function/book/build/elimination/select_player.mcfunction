...
function ww:book/build/elimination/_set_trigger_command with storage ww:temp setTriggerCommandInput

data modify storage ww:temp lineInput.uuid set from entity @s UUID
function ww:book/build/elimination/_line with storage ww:temp lineInput
