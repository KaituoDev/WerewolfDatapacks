...
$function ww:config/board/action/map/_reset {batch: 0, origin: $(origin)}
...
$execute at @e[nbt={UUID:$(origin)}] run data merge block ^1 ^-1 ^1 { \
  front_text:{has_glowing_text:0b, messages: ['""', \
  '{"text":"下一页","color":"gold","bold":true,"clickEvent":{"action":"run_command","value":"/function ww:config/board/action/_run {func: \\"ww:config/board/page/map/_2\\", args: {}}"}}', \
  '""','""'], color:"white"} \
}
