...
execute if score %totalBads ww.system matches 1.. run tellraw @s {"text":"狼人陣營","color":"red","bold":true}
...
execute if score %totalGoods ww.system matches 1.. run tellraw @s {"text":"人類陣營","color":"#50d300","bold":true}
...
execute if score %totalSpirits ww.system matches 1.. run tellraw @s {"text":"怨靈陣營","color":"dark_red","bold":true}
