...
execute if score %success var matches 1 run tag @s add pairedA
tag @p[tag=currentTarget] add pairA
...
execute if score %success var matches 1 run clear @s written_book{pair_a:1b,vote:1b}